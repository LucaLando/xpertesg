...
# Dados simulados
from gerar_base_grande import gerar_base_clientes_grande
import joblib

# Simular base e aplicar modelo preditivo
df = gerar_base_clientes_grande()

# Aplicar o modelo preditivo ao DataFrame
...
df["esg_predito"] = modelo_pipeline.predict(X).astype(int)
